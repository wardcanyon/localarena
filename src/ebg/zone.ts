...
export default class EbgZone {
  ...
  updateDisplay(): void {
    ...
    for (var idx in this.items) {
      ...
      var itemEl = $(item);
      if (itemEl) {
        var itemCoords = this.itemIdToCoords(
          j,
          elPos.w,
          elPos.h,
          this.items.length,
  ...
  itemIdToCoords(
    ...
    switch (this.item_pattern) {
      ...
      case "verticalfit":
        return this.itemIdToCoordsVerticalFit(
          i,
          controlWidth,
          controlHeight,
          itemCount,
      ...
      case "horizontalfit":
        return this.itemIdToCoordsHorizontalFit(
          i,
          controlWidth,
          controlHeight,
          itemCount,
      ...
      case "ellipticalfit":
        return this.itemIdToCoordsEllipticalFit(
          i,
          controlWidth,
          controlHeight,
          itemCount,
