    ...
    return declare("bgagame.thecrew", ebg.core.gamegui, {
        ...
        */
        ...
        onEnteringState: function( stateName, args )
        {
            ...
            case 'playerTurn':
        		...
        		if(!this.isSpectator && args.args.players[this.player_id]['canCommunicate'])
        		{
                    $('pagemaintitletext').innerHTML = $('pagemaintitletext').innerHTML + _(" or {you} can communicate").replace("{you}",this.divYou());
     ...
     // Enable to declare an optional parameter and its value
        ...
        createCardTooltip : function(card_HTML_id, color, value) {            
            ...
            {
            	msg = _("Reminder card");
                 this.addTooltipHtml( card_HTML_id, this.format_block('jstpl_tooltip_common', {title: _('Reminder card'), description: _('On table, it allows you to start communication by clicking on it <b>before</b> a trick. <br/>In hand, its purpose is to remind you that your communicated card is still on the table.') }));
        ...
        */
        ...
        { 
        	...
        	if(elem == null)
        	{
	        	this.showBubble( 'tasks_'+notif.args.player_id, notif.args.content, 0, 2000, 'bubble_custom' ) ;
        	}        	
        },
        ...
        divYou : function() {
            ...
            var you = "<span style=\"font-weight:bold;color:#" + color + ";" + color_bg + "\">" + __("You") + "</span>";
            return you;
        },
   });             
});
